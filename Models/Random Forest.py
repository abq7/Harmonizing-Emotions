...
valence_model = RandomForestRegressor(n_estimators=100, max_depth=10, random_state=42)
arousal_model = RandomForestRegressor(n_estimators=100, max_depth=10, random_state=42)
...
valence_accuracy = valence_model.score(X_test, y_test_valence)
arousal_accuracy = arousal_model.score(X_test, y_test_arousal)

print("Evaluation Results:")
print(f"Valence - MAE: {valence_mae:.4f}, MSE: {valence_mse:.4f}, R^2: {valence_r2:.4f}, Accuracy: {valence_accuracy:.4f}")
print(f"Arousal - MAE: {arousal_mae:.4f}, MSE: {arousal_mse:.4f}, R^2: {arousal_r2:.4f}, Accuracy: {arousal_accuracy:.4f}")